...
const xEnter = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["animation"])([
...
*/
const yEnter = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["animation"])([
...
*/
const imageEnter = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["animation"])([
...
*/
const imageLeave = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["animation"])([
...
*/
const iconButtonEnter = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["animation"])([
...
*/
const primaryButtonClick = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["animation"])([
...
*/
const xMouseEnter = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["animation"])([
...
let NavigationsComponent = class NavigationsComponent {
    ...
    ngOnInit() {
        ...
        let pages = _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["routes"].reduce((acc, value) => {
...
let ProfileService = class ProfileService {
    ...
    register(formValue) {
        return this.http.post('/api/user/register', formValue).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((user) => {
            console.log(user);
            this.userSource.next(user);
            return user;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(error)));
...
let RegisterComponent = class RegisterComponent {
    ...
    register() {
        this.profileService.register(this.registerForm.value).subscribe((response) => {
            if (response && response.id) {
                this.router.navigate(['/user/profile']);
