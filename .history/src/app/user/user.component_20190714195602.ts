...
import { iconButtonEnter, xEnter, imageEnter, imageLeave, primaryButtonClick } from '../animations/anim-fn';
...
@Component({
  ...
  animations: [
      ...
      trigger('primaryButtonClick', [
         transition(':enter', [            
            useAnimation(primaryButtonClick)
         ])
      ]) 
