...
import { yMouseEnter } from '../animations/anim-fn';
...
export class UserComponent implements OnInit {
  ...
  ngOnInit() {
      this._postService.postCard.subscribe(
         (response: Post) => {
  ...
  enterCard(event)
  {
     console.log(this.postId, event.target.id);
     if(this.postId === event.target.id) this.mouseEnterCard = true;
  }
...
export class PostCards{   
   ...
   {  
      let id: Post['id'] = event.target.id;
      this._postService.setPostSourceValue(id);
