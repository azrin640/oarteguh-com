...
export const routes: Routes = [
  ...
  { path: 'post/:user/:id/:title', component: PostComponent, data: { name: 'Post', icon: 'menu_book', tooltip: 'Post', type: 'public' } },
  { path: 'contact', component: ContactFormComponent, data: { name: 'Contact Us', icon: 'alternate_email', tooltip: 'Contact Us', type: 'public' }}, 
  { path: 'services', component: SalesPageComponent, data: { name: 'Services', icon: 'devices', tooltip: 'Services', type: 'customer' }}, 
