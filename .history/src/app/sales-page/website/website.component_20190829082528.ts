...
export class WebsiteComponent implements OnInit {
   ...
   issues = [      
      {
         id: 'package',
         title: 'Anda sedang merangka strategi untuk <span class="lm__text-title-1-7rem-primary">mencari pelanggan baru</span> atau <span class="lm__text-title-1-7rem-primary">meluaskan pasaran</span> barangan jualan atau servis anda? Maklumlah zaman sekarang kebanyakan sale adalah secara atas talian. <br> <br> Tiada siapa yang tahu atau dapat tolong atau beri penerangan kepada anda macamana nak buat <span class="lm__text-title-1-7rem-primary">Landing Page</span>, <span class="lm__text-title-1-7rem-primary">Sales Page</span>, <span class="lm__text-title-1-7rem-primary">Blog</span>, <span class="lm__text-title-1-7rem-primary">Iklan Google/Facebook</span> atau konten yang akan menarik banyak <span class="lm__text-title-1-7rem-primary">Like dan Share</span>?',
         image: 'strategy.jpg'
      },
      {
         id: 'webmaster',
