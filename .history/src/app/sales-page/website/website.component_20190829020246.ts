...
export class WebsiteComponent implements OnInit {
   ...
   issues = [
      ...
      {
         id: 'webmaster',
         title: 'Atau bajet syarikat anda <span class="lm__text-title-primary">tidak mampu</span> untuk menggaji Digital Manager atau Ecommerce Manager yang rata rata gaji mereka RM5K ke atas sebulan tapi anda tahu pentingnya perniagaan atas talian yang mempunyai 18 juta pengguna Malaysia. Nak buat sendiri makan  <span class="lm__text-title-primary">masa yang panjang</span> dan  <span class="lm__text-title-primary">kos yang tinggi</span>.',
         image: 'stress.jpg'
      }
   ];
   active: string;
