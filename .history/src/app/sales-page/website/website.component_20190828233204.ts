...
export class WebsiteComponent implements OnInit {
   ...
   issues = [
      ...
      {
         title: 'Atau anda sedang merangka strategi untuk <span class="lm__text-title-primary">mencari pelanggan baru</span> atau <span class="lm__text-title-primary">meluaskan pasaran</span> barangan jualan anda? Maklumlah zaman sekarang kebanyakan sale adalah secara atas talian.Tiada siapa yang tahu atau dapat tolong atau beri penerangan kepada anda macamana nak buat?',
         image: 'strategy.jpg'
      },
      {
