...
export class WebsiteComponent implements OnInit {
   ...
   issues = [
      { 
         id: 'custom',
         title: 'Anda didatangi <span class="lm__text-title-1-7rem-primary">idea</span> yang unik untuk perniagaan baru atas talian? Mungkin anda suka bisnes model Lizada, Lilong, Midah atau lain lain yang dipanggil <span class="lm__text-title-1-7rem-primary">Multivendor Website</span> ? Diorang tak perlu buat apa-apa, sedar sedar duit masuk.',
         image: 'ideas.jpg'
      },
      {
         id: 'package',
         title: 'Atau anda sedang merangka strategi untuk <span class="lm__text-title-1-7rem-primary">mencari pelanggan baru</span> atau <span class="lm__text-title-1-7rem-primary">meluaskan pasaran</span> barangan jualan atau servis anda? Maklumlah zaman sekarang kebanyakan sale adalah secara atas talian.Tiada siapa yang tahu atau dapat tolong atau beri penerangan kepada anda macamana nak buat?',
         image: 'strategy.jpg'
      },
      {
         id: 'webmaster',
