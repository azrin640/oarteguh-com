...
export class WebsiteComponent implements OnInit {
   ...
   issues = [
      ...
      {
         title: 'Atau anda mencari cara baru untuk mencari pelanggan atau meluaskan pasaran barangan jualan anda? Maklumlah zaman sekarang kebanyakan sale atas talian.Tiada siapa yang tahu atau dapat tolong anda?',
         image: 'strategy.jpg'
      },
      {
