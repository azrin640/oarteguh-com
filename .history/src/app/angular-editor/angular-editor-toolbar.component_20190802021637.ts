...
export class AngularEditorToolbarComponent {
  ...
  headingOptions = [
     { title: 'Heading 1', class: 'h1', value: 'h1' },
     { title: 'Heading 2', class: 'h2', value: 'h2' },
     { title: 'Heading 3', class: 'h3', value: 'h3' },
     { title: 'Heading 4', class: 'h4', value: 'h4' },
     { title: 'Heading 5', class: 'h5', value: 'h5' },
     { title: 'Heading 6', class: 'h6', value: 'h6' }
   ];
   selected = 'h1';
