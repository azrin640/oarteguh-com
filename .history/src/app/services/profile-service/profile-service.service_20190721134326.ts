...
export class ProfileService {
  ...
  constructor( 
   ...
   {
      return this.http.post('/api/user/profile/update/autocomplete/state-country', city).pipe(
         catchError(error => throwError(error))
      );
   }
   ...
   {
      return this.http.post('/api/user/profile/update/autocomplete/country', state).pipe(
         catchError(error => throwError(error))
      );
   }
