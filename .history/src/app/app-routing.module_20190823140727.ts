...
export const routes: Routes = [
  ...
  // Admin routes
  { path: 'admin/serial', component: AdminSerialComponent, canActivate: [AuthGuardService, AdminAuthGuardService], data: { name: 'Serial' ,icon: 'dashboard', type: 'admin' } },
  ...
  { path: 'admin/posts/post/preview', component: PreviewPostComponent, canActivate: [AuthGuardService, AdminAuthGuardService], data: { name: 'Post', icon: 'book', type: 'admin'  } },
