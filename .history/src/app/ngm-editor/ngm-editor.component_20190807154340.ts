...
export class NgmEditorComponent implements OnInit {
   ...
   {           
         ...
         if(selected && selected.type === 'caret'){  
            ...
            let newNode = document.getElementById(newElement.id);
            // selection.collapse(newNode);
            // let newRange = selection.addRange(newNode);
            console.log(newNode.DOCUMENT_POSITION_CONTAINED_BY); 

            // let newNode = document.getElementById(newElement.id);
            // selection.collapseToEnd();
            // selection.selectAllChildren(newNode);
            // selection.setPosition(newNode);
            // selection.addRange();
