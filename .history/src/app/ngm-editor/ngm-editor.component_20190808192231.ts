...
export class NgmEditorComponent implements OnInit {
   ...
   {           
         ...
         else if(command === 'align-left') command = 'span';
         else if(command === 'align-center') command = 'span';
         else command;
         ...
         else if(id === 'align-left') attrb.value = `ngm__span-${id}`;
         else if(id === 'align-center') attrb.value = `ngm__span-${id}`;
   ...
   clearFormat(){
      ...
      let rangeContents = range.cloneContents();
      rangeContents.normalize();
      let childNodes = rangeContents.childNodes;
      let contents = Object.keys(rangeContents)
         .reduce((acc, value)=>{
            if(value === 'text') acc = value;
            return acc;
         }, {});
