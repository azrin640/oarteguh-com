...
export class NgmEditorComponent implements OnInit {
  ...
  createElement(command): HTMLElement
  {
      ...
      if(command === 'italic') attrb.value = `ngm__span-${command}`;
      else attrb.value = `ngm__${command}`;
  ...
  createNode(button: MatButton){
      ...
      let newElement = this.createElement(cmdButton);
      // let newElement = document.createElement(cmdButton);
      // newElement.id = selected.element.id;
      // let attrb = document.createAttribute('class');
      // if(cmdButton === 'italic') attrb.value = `ngm__span-${cmdButton}`;
      // attrb.value = `ngm__${cmdButton}`;
      // newElement.setAttributeNode(attrb);
