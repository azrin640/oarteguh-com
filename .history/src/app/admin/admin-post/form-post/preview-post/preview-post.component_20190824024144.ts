...
export class PreviewPostComponent implements OnInit {
  ...
  constructor(
     ...
     private sanitizer: DomSanitizer
         ...
         this.safeContent = this.sanitizer.bypassSecurityTrustHtml(this.content) as HTMLDivElement;
         ...
         this.postService.postContent.subscribe(
            (response: any) => { 
               let sanitizedResponse = this.sanitizer.bypassSecurityTrustHtml(response);
               this.content = sanitizedResponse as string;
               this.contentExist = true;
            }
         );
