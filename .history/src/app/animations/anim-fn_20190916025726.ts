...
export const banner2Enter = animation([
   query('.banner2-enter', [
      ...
      stagger(-30, [
         animate('2.5s cubic-bezier(.42,.14,.93,.53)', style({ opacity: 1, transform: 'none' }))
      ])
   ], { optional: true }
)])      //
...
export const banner3Enter = animation([
   query('.banner3-enter', [
      ...
      stagger(-30, [
         animate('2.5s cubic-bezier(.58,-0.36,0,1.91)', style({ opacity: 1, transform: 'none' }))
      ])
   ], { optional: true }
)])      //
...
export const banner5Enter = animation([
   query('.banner5-enter', [
      ...
      stagger(-30, [
         animate('2.5s ease-in', style({ opacity: 1, transform: 'none' }))
      ])
   ], { optional: true }
)])      //
